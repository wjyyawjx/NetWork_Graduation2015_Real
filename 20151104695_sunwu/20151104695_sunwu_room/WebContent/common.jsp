 ...
 <body class=""> 
  <!--<![endif]-->
           ...
           <!--       <li><a href="#" class="hidden-phone visible-tablet visible-desktop" role="button">Settings</a></li>       -->   
                    <li id="fat-menu" class="dropdown">
                        <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-user"></i> 注销用户
                            <i class="icon-caret-down"></i>
                        </a>

                        <ul class="dropdown-menu">
                            <li><a tabindex="-1" href="sign-in.jsp">切换用户</a></li>
                        
                            <li><a tabindex="-1" href="sign-in.jsp">注销用户</a></li>
                        </ul>
                    </li>
                    
                </ul>
                <a class="brand" href="common.jsp"><span class="first"></span> <span class="second">首页</span></a>
        </div>
    </div>
    ...
    <div class="sidebar-nav">
        <a href="#dashboard-menu" class="nav-header" data-toggle="collapse"><i class="icon-dashboard"></i>会议室预约</a>
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            <li><a href="common.jsp">Home</a></li>
          
            <li ><a href="media.html">查看会议室</a></li>
            <li ><a href="calendar.html">查看日历</a></li>
            
        </ul>

        <a href="#accounts-menu" class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>用户管理<span class="label label-info">+3</span></a>
        <ul id="accounts-menu" class="nav nav-list collapse">
            <li ><a href="sign-in.jsp">用户登录</a></li>
            <li ><a href="sign-up.jsp">注册用户</a></li>
        ...
        <a href="faq.html" class="nav-header" ><i class="icon-comment"></i>留言</a>
    </div>
