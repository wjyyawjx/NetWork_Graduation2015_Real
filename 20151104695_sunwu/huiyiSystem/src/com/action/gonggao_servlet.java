...
public class gonggao_servlet extends HttpServlet
{
	public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException 
	{
		...
		if(type.endsWith("gonggaoUpdate1"))
		{
			gonggaoUpdate1(req, res);
		}
	}
	...
	public void gonggaoAdd(HttpServletRequest req,HttpServletResponse res)
	{
		...
		req.setAttribute("message", "公告发布成功");
	...
	public void gonggaoUpdate1(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	{
		String id=req.getParameter("id");
		Tgonggao gonggao=new Tgonggao();
		...
		req.getRequestDispatcher("admin/gonggao/gonggaoUpdate.jsp").forward(req, res);
	}
