...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<form method="post" action="<%=path %>/userPwEdit.action" name="formPw" class="form-horizontal form-label-left">
		...
		<div class="col-xs-6">
		 <input type="text" value="${sessionScope.admin.userName }" name="userName" size="20" disabled="disabled"  class="form-control col-xs-6"/>
		</div>
		</div> 
		...
		<div class="col-xs-6">
		 <input type="password" name="userPw" id="userPw" size="22"class="form-control col-xs-6" />
		</div>
		</div> 
		...
		<div class="col-xs-6">
		        <input type="password" id="userPw1" name="userPw1" size="22"class="form-control col-xs-6" />
		</div>
		</div> 
