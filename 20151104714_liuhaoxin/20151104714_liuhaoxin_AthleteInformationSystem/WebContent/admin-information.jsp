			...
			<td><h2>修改密码</h2>
				...
				<form target="parent" action="PwdUpload" method="post">
					<input type="password" id="pwd" Name="password"
						onkeyup="validate()" placeholder="密码" required=""> <input
						type="password" id="pwd1" Name="Password1" onkeyup="validate()"
						placeholder="确认密码" required=""><br> <span id="tishi"></span>
					<input id="sub" type="submit" disabled="value" value="修改密码"></td>
			</form>
			<td><h2>修改邮箱</h2>
