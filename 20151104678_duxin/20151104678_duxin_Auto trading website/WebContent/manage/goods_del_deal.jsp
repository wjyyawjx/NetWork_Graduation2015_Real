...
<body>
	...
	if (!rs.next()){
	      ...
	      if (ret!=0){
	    	  out.println("<script language='javascript'>alert('商品信息删除成功！');window.location.href='ht_index.jsp';</script>");
	        }else{
	          out.println("<script language='javascript'>alert('该商品信息不能删除！');window.location.href='ht_index.jsp';</script>");
	        }
	      }
	%>
</body>
