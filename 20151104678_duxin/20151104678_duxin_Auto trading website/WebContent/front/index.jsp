<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<jsp:useBean id="conn" scope="page" class="com.tools.ConnDB" />
		...
		ResultSet rs_new = conn.executeQuery(
				"select  t1.ID, t1.GoodsName,t1.price,t1.picture,t2.TypeName from tb_goods t1,tb_subType t2 where t1.typeID=t2.ID and t1.newGoods=1 order by t1.INTime desc limit 12");		//查询最新上架商品信息
		...
		ResultSet rs_sale = conn.executeQuery(
				"select  t1.ID, t1.GoodsName,t1.price,t1.nowPrice,t1.picture,t2.TypeName from tb_goods t1,tb_subType t2 where t1.typeID=t2.ID and t1.sale=1 order by t1.INTime desc limit 12");		//查询打折商品信息
		...
		/* 热门商品信息 */
		ResultSet rs_hot = conn.executeQuery("select ID,GoodsName,nowprice,picture from tb_goods order by hit desc limit 2");		//查询热门商品信息
								...
								<div class="container_oc">
									<div class="row">
										<!-- 循环显示最新上架商品 ：添加12条商品信息-->
									 	<%
										while (rs_new.next()){ // 循环
											new_ID = rs_new.getInt(1);//获取数据
