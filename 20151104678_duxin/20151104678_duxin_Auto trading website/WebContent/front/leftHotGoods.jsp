...
<%
	...
	if(request.getParameter("type")!=null && request.getParameter("type")!=""){
		...
		sql="select t1.ID,t1.GoodsName,t1.nowprice,t1.picture from tb_goods t1,tb_subType t2 where t1.typeID=t2.ID and t2.superType="
		...
		sql="select ID,GoodsName,nowprice,picture from tb_goods where typeID=" + typeSystem
				+ " order by hit desc,ID asc limit 7";
	}else{
		sql="select ID,GoodsName,nowprice,picture from tb_goods order by hit desc limit 7";
	}
%>
<div
