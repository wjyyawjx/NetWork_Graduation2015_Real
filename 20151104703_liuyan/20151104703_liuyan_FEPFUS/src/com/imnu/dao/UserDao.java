...
public interface UserDao {
	...
	public void registerUser(@Param("u_name")String u_name,@Param("u_pwd") String u_pwd,@Param("u_email") String u_email,@Param("u_phone") String u_phone,@Param("u_type") String u_type);
