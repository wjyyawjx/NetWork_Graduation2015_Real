...
<table id="stuDetailList">
  ...
  %>
	...
	<tr>
     <td>商品名：</td>
    <td><input type="text" id="stuName" name="stuName" value="<%=stu.getName() %>"></td>
  </tr>
    <tr>
    <td>价格：</td>
    <td><input type="text" id="sex" name="sex"  value="<%=stu.getSex() %>"> </td>
  </tr>
    <tr>
    <td>数量：</td>
    <td><input type="text" id="stuAge" name="stuAge" value="<%=stu.getAge() %>"></td>
  </tr>
