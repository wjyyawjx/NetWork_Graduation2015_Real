...
var MagicZoom_ua='msie';var W=navigator.userAgent.toLowerCase();if(W.indexOf("opera")!=-1){
  ...
  this.popupSizeX=100;if(this.settings&&this.settings["header"]!=""){
    ...
    var bigimgsrc=this.bigImage.src;if(this.bigImageSizeY<parseInt(this.bigImageCont.style.height)){
        ...
        var f=document.createElement("DIV");f.className='MagicZoomHeader';f.id='MagicZoomHeader'+this.bigImageCont.id;f.style.position='relative';f.style.display='none';f.style.zIndex=10;f.style.left='0px';f.style.top='0px';f.style.padding='3px';f.innerHTML=this.settings["header"];this.bigImageCont.appendChild(f)
