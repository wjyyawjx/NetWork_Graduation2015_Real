...
<form action="" method="post">
				<span>教师注册</span><br />
				<label>姓名：</label>
				<input type="text" name="teacher_name" placeholder="请输入您的真实姓名" />
				<br />
				<label>工号：</label>
				<input type="text" name="teacher_num" placeholder="请输入您的真实工号" />
				<br />
				<label>QQ：</label>
				<input type="text" name="teacher_qq" />
				<br />
				<label>电话：</label>
				<input type="text" name="teacher_phone_num" />
				<br />
				<label>email：</label>
