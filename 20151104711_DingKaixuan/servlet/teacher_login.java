...
public class teacher_login extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String usernum = request.getParameter("teacher_num");
		...
		teacherloginbean.setTeacher_num(usernum);
		...
		teacherloginbean user = teacherlogindao.login(teacherloginbean);
			...
			if (user != null) {//判断用户名密码是否存在
				...
				//页面弹框，提示错误，可以不用。
				JOptionPane.showMessageDialog(null, "工号或密码错误", null, JOptionPane.ERROR_MESSAGE);
				//重定向
