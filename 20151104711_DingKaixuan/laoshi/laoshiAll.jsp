...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="margin: 0px;">
		 <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA">
				...
				<c:forEach items="${requestScope.laoshiList}" var="laoshi" varStatus="ss">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a href="#" onclick="a('${laoshi.id}','${laoshi.xingming}')" style="color: green;font-family: 微软雅黑;font-size: 15px;">${laoshi.xingming}</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					    ${laoshi.xingbie }
					</td>
