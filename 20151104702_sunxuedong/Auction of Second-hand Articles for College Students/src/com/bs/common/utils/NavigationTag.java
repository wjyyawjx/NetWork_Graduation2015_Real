...
public class NavigationTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		writer.print("<li><a href=\"" + homeUrl + "\">" + "棣栭〉</a></li>");
		writer.print("<li><a href=\"" + preUrl + "\">" + "涓婁竴椤�</a></li>");
			} else {
writer.print("<li class=\"disabled\"><a href=\"#\">" + "棣栭〉 </a></li>");
...
writer.print("<li><a href=\"" + pageUrl + "\">" + indexPage + "</a></li>");
		...
		writer.print("<li><a href=\"" + backUrl + "\">" + "灏鹃〉</a></li>");
			} else {
writer.print("<li class=\"disabled\"><a href=\"#\">" + "涓嬩竴椤�</a></li>");
writer.print("<li class=\"disabled\"><a href=\"#\">" + "灏鹃〉</a></li>");
			}
			writer.print("</nav>");
		} catch (IOException e) {
			e.printStackTrace();
