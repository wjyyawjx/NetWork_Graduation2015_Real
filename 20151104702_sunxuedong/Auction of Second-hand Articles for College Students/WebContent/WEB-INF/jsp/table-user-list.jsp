				...
				<ul class="tpl-left-nav-menu">
					...
					<li class="tpl-left-nav-item">
						...
						class="nav-link tpl-left-nav-link-list active"> <i
							class="am-icon-table"></i> <span>信息表单</span> <!-- 列表打开状态的i标签添加 tpl-left-nav-more-ico-rotate 图表即90°旋转  -->
							<i
						...
						<ul class="tpl-left-nav-sub-menu">
							<li>
								...
								href="${pageContext.request.contextPath }/table-goods-list-admin.action">
									...
									<i class="am-icon-angle-right"></i> <span>评价信息</span>
						...
						<div class="am-u-sm-12">
							<form class="am-form">
								<table
									...
									<tbody>
										<c:forEach items="${page.rows_u}" var="rows_u">
											<tr>
												<td>${rows_u.id}</td>
												<td>${rows_u.username}</td>
												<td>${rows_u.sex}</td>
												<td>${rows_u.phone}</td>
												<td>${rows_u.qq}</td>
												<td>${rows_u.university}</td>
